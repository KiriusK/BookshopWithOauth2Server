...
import ru.kirius.data_storage_service.services.BookPdfService;

@RestController
@RequestMapping("/pdf")
public class PdfBookController {

    private final BookPdfService service;
    private final Logger logger;

    public PdfBookController(BookPdfService service) {
        this.service = service;
        this.logger = LoggerFactory.getLogger(PdfBookController.class);
    }
